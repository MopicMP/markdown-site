...
> Convert Markdown folder to HTML site

[![PyPI version](https://badge.fury.io/py/markdown-site.svg)](https://pypi.org/project/markdown-site/)
...
```bash
pip install markdown-site
```

## Quick Start

```python
from markdown_site import site
...
from markdown_site import batch
